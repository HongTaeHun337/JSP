...
//			
//			pagebar += String.format(" <ahref='/semi/board/list.do?page=%d'>%d</a>"
//										, i,i);
//			
//		}
//		
		...
		while (!(loop > blockSize || n > totalPage)) {
			...
			if (n == nowPage) {
				pagebar += String.format(" <a href='#!' style='color:tomato;'>%d</a>"
									, n);
			} else {
				pagebar += String.format(" <a href='/semi/board/list.do?page=%d'>%d</a>"
									, n,n);
			}
			loop++;
			n++;
