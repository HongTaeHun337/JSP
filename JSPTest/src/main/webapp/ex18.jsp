...
<%
	...
	//디렉토리 탐색
	//- C:\code\server\.metadata\.plugins\org.eclipse.wst.server.core\tmp1\wtpwebapps\JSPTest\pic
...
<body>
	...
	<!-- 
	 ...
	 <div id="list">
		<% for (File file : list) { %> 
		<div class="item" style="background-image:url(pic/<%= file.getName() %>)"
		data-modal-button="view">
